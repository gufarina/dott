<p align="center">
  <img src="docs/img/github-header.png" alt="Dott: anote antes de decidir onde anotar" width="100%">
</p>
...
<p align="center">
  <img src="docs/img/widget-painel-aberto-digitando.png" alt="Widget do Dott aberto, com uma ideia sendo digitada" width="600">
</p>
...
<p align="center">
  <img src="docs/img/app-tela-inicial.png" alt="Tela principal do Dott com a Caixa de Entrada, o PARA e as tarefas" width="600">
</p>
...
<p align="center">
  <img src="docs/img/app-pasta-e-tarefas.png" alt="Uma pasta aberta no Dott, com tarefas e notas ligadas" width="600">
</p>
...
<p align="center">
  <img src="docs/img/app-nota-conectada.png" alt="Uma nota aberta no editor do Dott, com etiquetas e conexões no rodapé" width="600">
</p>
...
<p align="center">
  <img src="docs/img/app-constelacao-conexoes.png" alt="A Constelação do Dott, com as notas ligadas e os temas encontrados" width="600">
</p>
...
O Dott é software proprietário do Studio Farina. O código está aqui aberto para leitura, avaliação
e transparência. Publicar não é licenciar: nenhum direito de cópia, modificação, redistribuição ou
uso em outro produto é concedido. Você pode ler o código e usar o instalador oficial das
[releases](https://github.com/gufarina/dott/releases). Para qualquer outro uso, peça autorização
abrindo uma [Issue](https://github.com/gufarina/dott/issues). Termos completos em [LICENSE](LICENSE).
