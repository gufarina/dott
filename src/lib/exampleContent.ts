...
export const INITIAL_PARA: Record<string, Quadrant> = {
  projects: {
    ...
    folders: [
      { id: 'start', name: 'Comece aqui', bg: 'oklch(24% 0.08 20)', notes: 0, tasks: 0, total: 0 },
      { id: 'primeiro', name: 'Meu primeiro projeto', bg: 'oklch(22% 0.07 295)', notes: 0, tasks: 0, total: 0 },
    ]
  },
  areas: {
    ...
    folders: [
      { id: 'habitos', name: 'Hábitos', bg: 'oklch(20% 0.08 258)', notes: 0, tasks: 0, total: 0 },
      { id: 'saude', name: 'Saúde', bg: 'oklch(20% 0.07 145)', notes: 0, tasks: 0, total: 0 },
    ]
  },
  resources: {
    ...
    folders: [
      { id: 'modelos', name: 'Modelos', bg: 'oklch(18% 0.08 295)', notes: 0, tasks: 0, total: 0 },
      { id: 'leituras', name: 'Leituras', bg: 'oklch(18% 0.05 60)', notes: 0, tasks: 0, total: 0 },
    ]
  },
  archives: {
    ...
    folders: [
      { id: 'concluidos', name: 'Concluídos', bg: 'oklch(16% 0.02 260)', notes: 0, tasks: 0, total: 0 },
    ]
  },
}
