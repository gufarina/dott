...
export function Onboarding() {
  ...
  return (
    <div className={`ob-overlay${closing ? ' is-closing' : ''}`}>
      <Button as="span" className="ob-skip-x" title="Pular introdução" onClick={finish}><Icon name="fechar" size={14} /></Button>
        ...
        <div className="ob-content">
          ...
          <div className={active(5)}>
            ...
            <div className="ob-choices">
              <Button className={`ob-choice${mode === 'local' && door !== 'form' ? ' is-on' : ''}`} aria-pressed={mode === 'local' && door !== 'form'} onClick={pickLocal}>
              ...
              <Button className={`ob-choice is-soon${door !== 'idle' ? ' is-on' : ''}`} aria-pressed={door !== 'idle'} onClick={pickCloud}>
            ...
            {door === 'form' && (
              <div className="ob-door">
                ...
                <div className="ob-door-row">
                  ...
                  />
                  <Button className="ob-btn primary hoverGlow" disabled={!isValidEmail(email)} onClick={() => void sendEmail()}>Avise-me</Button>
                </div>
