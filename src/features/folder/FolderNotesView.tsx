...
import { RenameFolderModal } from '../para/RenameFolderModal'
...
export function FolderNotesView() {
  ...
  /** true abre a caixa de trocar o nome da pasta aberta agora. */
  ...
  return (
    <div className={s.wrap}>
      ...
      <div className={s.toolbar}>
        ...
        {!isSemPasta && (
          <>
            ...
            <Button className={`${s.btnNewAlt} hoverZoom hoverGlow`} onClick={() => setRenomeando(true)} title="Trocar o nome desta pasta">
              <Icon name="lapis" size={14} /> Renomear
            </Button>
      ...
      {novaTarefa && (
        <Modal title="Nova tarefa" onClose={() => { setNovaTarefa(false); setTextoTarefa(''); setPrazoTarefa(null) }}>
          ...
          <div className={s.novaTarefaPrazo}>
            ...
            <Button className={s.novaTarefaPrazoAtalho} onClick={() => setPrazoTarefa(hojeISO())}>
              Hoje
            </Button>
            <Button className={s.novaTarefaPrazoAtalho} onClick={() => setPrazoTarefa(amanhaISO())}>
              Amanhã
            </Button>
            {prazoTarefa && (
              <Button
      ...
      {renomeando && category && folder && !isSemPasta && (
        <RenameFolderModal
          categoryId={category}
          folderId={folder}
          nomeAtual={folderObj?.name ?? ''}
