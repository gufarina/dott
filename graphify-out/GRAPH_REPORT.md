...
## Corpus Check
- 52 files · ~124,786 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 251 nodes · 295 edges · 46 communities detected
...
- `doRestore()` --calls--> `showToast()`  [INFERRED]
  C:\Users\Lite OS\Projetos\dott-warmfox\src\components\Settings.tsx → src\components\Toast.tsx
- `showToast()` --calls--> `newNote()`  [INFERRED]
  src\components\Toast.tsx → C:\Users\Lite OS\Projetos\dott-warmfox\src\features\folder\FolderNotesView.tsx

## Communities

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (16): onDragEnd(), onWindowDrop(), imageFromEvent(), saveImageFile(), criarPasta(), newNote(), onFile(), onNoteFile() (+8 more)
...
Cohesion: 0.17
Nodes (6): buildGraph(), canon(), fold(), plainText(), tokens(), graphOf()

### Community 4 - "Community 4"
Cohesion: 0.29
Nodes (11): abrirTarefa(), cap(), clip(), descapitalizar(), firstLine(), hostOf(), keywords(), paraInfinitivo() (+3 more)
...
- **Thin community `Community 26`** (2 nodes): `currentLabel()`, `main.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `BootLoader()`, `BootLoader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `Breadcrumb()`, `Breadcrumb.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (2 nodes): `CardTypeIcon()`, `CardTypeIcon.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (2 nodes): `DottMark()`, `DottMark.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (2 nodes): `Icon()`, `Icon.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (2 nodes): `ModalPortal()`, `ModalPortal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (2 nodes): `SearchModal()`, `SearchModal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (2 nodes): `Titlebar.tsx`, `Titlebar()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `ImageViewer()`, `ImageViewer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `Constellation.tsx`, `Constellation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `main()`, `build.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `widget_geo.rs`, `widget_set_geometry()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `vite.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `vite-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `GlyphPicker.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `seedNotes.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `README.md - template Tauri+React+TypeScript`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `landing/lp-dott-lancamento-2026-08-09.html - LP mesma copy, revisao de 09/08`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `Dott Widget - Painel de Nota Aberto (digitando)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `showToast()` connect `Community 0` to `Community 8`, `Community 1`, `Community 6`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `capture()` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `abrirTarefa()` connect `Community 4` to `Community 0`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 15 inferred relationships involving `showToast()` (e.g. with `onWindowDrop()` and `onDragEnd()`) actually correct?**
  _`showToast()` has 15 INFERRED edges - model-reasoned connections that need verification._
